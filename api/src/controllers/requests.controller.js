...
const setRequestGame = async (req, res) => {
    ...
    const response = await pool.query('insert into detalle_pedido(id_pedido, id_producto, cantidad,devuelto) select ped.id_pedido as id_pedido, $2 as "id_producto", 1 as "cantidad",false from pedido as ped where ped.id_usuario = $1', [id_usuario, id_producto]);
